...
class Tweet
  ...
  def initialize
    ...
    Twitter.configure do |config|
      config.consumer_key       = '6IWeIFEtLq6vZMoQAeLYw'
      config.consumer_secret    = 'NTrT5dOL6p8xleQQBwerPH4RRnF4WCp8knsWUNOao'
      config.oauth_token        = '595589986-pZeEkg7oC4QRcgDDzWxoUwZLRkiVSQRtCLZFXzyR'
      config.oauth_token_secret = 'L1fhcjj2shLl8dX45WAwT9qBXHTO16yYL7Nleiv3UQ'
    end
  end
...
hLl8dX45WAwT9qBXHTO16yYL7Nleiv3UQd
